        ...
        <table>
            <tr>
                ...
                <td style="width: 420px"> 
                    ...
                    @endif
                    <p style="font-size: 14px">Agenda del {{$fecha_letra}} <br>al {{$fecha_letra_fin}}</p>
                </td>
        ...
        <div class="contenido">
        	...
        	<p class="evento">
        		...
        		<h4>{{$evento->concepto}}   &nbsp;&nbsp;<span> <strong>(Cita {{$evento->tipo_cita}})</strong></span></h4>
        			<h5><i class="fas fa-clock"></i> {{ substr($evento->fecha_inicio, 0, 10) }} {{ substr($evento->fecha_inicio, 10) }} a  {{ substr($evento->fecha_fin, 10) }}</h5>
        		<ul>
